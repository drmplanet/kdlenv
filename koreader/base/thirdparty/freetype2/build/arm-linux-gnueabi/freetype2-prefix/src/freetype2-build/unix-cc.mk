...
CC           := arm-linux-gnueabi-gcc -static-libstdc++
COMPILER_SEP := $(SEP)
...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -O2 -ffast-math -pipe -fomit-frame-pointer  -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mthumb -mfloat-abi=softfp -fno-finite-math-only -fno-stack-protector -U_FORTIFY_SOURCE -fPIC -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS := -Wl,-O1 -Wl,--as-needed -static-libstdc++ -march=armv7-a
